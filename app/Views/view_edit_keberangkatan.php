...
<div class="container">
    <div class="card">
        ...
        <form action="<?= base_url('keberangkatan/edit'); ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="card-body">
                <?php foreach ($keberangkatan as $row) :  ?>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control <?= ($validation->hasError('kode')) ? 'is-invalid' : ''; ?>" id="kode" name="kode" value="<?= $row['keberangkatanKode']; ?>" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <label>Tujuan</label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="nama" name="nama" value="<?= $row['tujuanNamaTempat']; ?>" required readonly class="form-control nama <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" />
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>Kota</label>
                                <input type="text" readonly class="form-control kota" value="<?= $row['tujuanKota']; ?>" id="kota" name="kota" required>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>Provinsi</label>
                                <input type="text" readonly class="form-control provinsi" value="<?= $row['tujuanProvinsi']; ?>" id="provinsi" name="provinsi" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control tglberangkat" value="<?= $row['keberangkatanTanggalMulai']; ?>" id="tglberangkat" name="tglberangkat" required>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>Tanggal Selesai</label>
                                <input type="date" class="form-control tglselesai" value="<?= $row['keberangkatanTanggalSelesai']; ?>" id="tglselesai" name="tglselesai" required>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>Lama Hari</label>
                                <input type="text" class="form-control lama" id="lama" name="lama" value="<?= $row['keberangkatanJangkaWaktu']; ?>" required>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
