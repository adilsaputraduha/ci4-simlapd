...
<div class="container">
    <div class="card">
        ...
        <form action="<?= base_url('pembiayaan/edit'); ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control <?= ($validation->hasError('kode')) ? 'is-invalid' : ''; ?>" id="kode" name="kode" value="<?= $row['pembiayaanKode']; ?>" required>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="keberangkatan" name="keberangkatan" value="<?= $row['pembiayaanKodeBerangkat']; ?>" required readonly class="form-control keberangkatan <?= ($validation->hasError('keberangkatan')) ? 'is-invalid' : ''; ?>" />
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                <div class="form-group">
                                    <label>Spt</label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="spt" name="spt" value="<?= $row['keberangkatanSpt']; ?>" required readonly class="form-control spt <?= ($validation->hasError('spt')) ? 'is-invalid' : ''; ?>" />
                                        <div class="invalid-feedback">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                <div class="form-group">
                                    <label>Tujuan</label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="tujuan" name="tujuan" value="<?= $row['tujuanNamaTempat']; ?>" required readonly class="form-control tujuan <?= ($validation->hasError('tujuan')) ? 'is-invalid' : ''; ?>" />
                                        <div class="invalid-feedback">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="pokok" name="pokok" onkeypress="return hanyaAngka(event)" value="<?= $row['pembiayaanPokok']; ?>" required class="form-control pokok <?= ($validation->hasError('pokok')) ? 'is-invalid' : ''; ?>" />
                                        <div class="invalid-feedback">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="transportasi" onkeypress="return hanyaAngka(event)" name="transportasi" value="<?= $row['pembiayaanTransportasi']; ?>" required class="form-control transportasi <?= ($validation->hasError('transportasi')) ? 'is-invalid' : ''; ?>" />
                                        <div class="invalid-feedback">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="penginapan" onkeypress="return hanyaAngka(event)" name="penginapan" value="<?= $row['pembiayaanPenginapan']; ?>" required class="form-control penginapan <?= ($validation->hasError('penginapan')) ? 'is-invalid' : ''; ?>" />
                                        <div class="invalid-feedback">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="lainlain" onkeypress="return hanyaAngka(event)" name="lainlain" value="<?= $row['pembiayaanLainLain']; ?>" required class="form-control lainlain <?= ($validation->hasError('lainlain')) ? 'is-invalid' : ''; ?>" />
                                        <div class="invalid-feedback">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <div class="form-group">
                                    <label>Total</label>
                                    <div class="input-group mb-3">
                                        <input type="text" readonly id="total" name="total" value="<?= $row['pembiayaanTotal']; ?>" required class="form-control total <?= ($validation->hasError('total')) ? 'is-invalid' : ''; ?>" />
                                        <div class="invalid-feedback">
