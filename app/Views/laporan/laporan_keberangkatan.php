...
<body>
    <center>
        ...
        <table class="head" style="margin-bottom: 20px;">
            <tr>
                <td>Laporan Data Keberangkatan</td>
            </tr>
        </table>
            ...
            <tbody>
                ...
                foreach ($keberangkatan as $row) : $no++ ?>
                    <tr style="height: 20px; text-align: center;">
                        ...
                        <td> <?= $row['keberangkatanSpt']; ?></td>
                        <td> <?= $row['tujuanNamaTempat']; ?></td>
                        <td> <?= $row['keberangkatanTanggalMulai']; ?></td>
                        <td> <?= $row['keberangkatanTanggalSelesai']; ?></td>
                        <td> <?= $row['keberangkatanJangkaWaktu']; ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        ...
        <table width="625">
            <tr>
                ...
                <td class="text" align="center">Padang &nbsp&nbsp&nbsp&nbsp<?= date("M Y"); ?><br>
                    KABID Pengadaan<br><br><br><br><br><br>
                    Asep<br>
                    NIP : 19640525 199602 2 021
                </td>
            </tr>
        </table>
    </center>
