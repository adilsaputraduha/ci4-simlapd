...
<div class="container">
    <div class="card">
        ...
        <form action="<?= base_url('sppd/save'); ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="card-body">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="spt" name="spt" required readonly class="form-control spt" />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="kendaraan" name="kendaraan" value="<?= old('kendaraan'); ?>" required class="form-control kendaraan <?= ($validation->hasError('kendaraan')) ? 'is-invalid' : ''; ?>" />
                                        <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="keterangan" placeholder="Optional" name="keterangan" value="<?= old('keterangan'); ?>" class="form-control keterangan <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" />
                                        <div class="invalid-feedback">
