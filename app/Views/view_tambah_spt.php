...
<div class="container">
    <div class="card">
        ...
        <form action="<?= base_url('spt/save'); ?>" id="formTambah" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control <?= ($validation->hasError('kode')) ? 'is-invalid' : ''; ?>" id="kode" name="kode" value="<?= $kode; ?>" required placeholder="Masukan nomor surat">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control <?= ($validation->hasError('tanggalkegiatan')) ? 'is-invalid' : ''; ?>" id="tanggalkegiatan" name="tanggalkegiatan" value="<?= old('tanggalkegiatan'); ?>" required>
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea required class="form-control <?= ($validation->hasError('agenda')) ? 'is-invalid' : ''; ?>" rows="3" name="agenda" id="agenda" placeholder="Masukan agenda perjalanan"><?= old('agenda'); ?></textarea>
                            <div class="invalid-feedback">
